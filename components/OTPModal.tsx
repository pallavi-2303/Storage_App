...
import {  resendOtp, verifySecret } from "@/lib/actions/users.actions";
import Image from "next/image";
import { sendOTPViaEmailJs } from "@/lib/email/sendClientOtp";
const OTPModal = ({
  accountId,
  email,
}: {
  ...
  const handleSubmit = async (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    try {
      const session = await verifySecret({ email,  otp  });
      console.log( session );
